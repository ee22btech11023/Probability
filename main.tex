...
\begin{enumerate}
  ...
  \solution Let the random variable X denotes true(1) or false(0) for a question with p being the probability that true is answered. Then,
   \begin{align}
  ...
  Suppose $X_i, 1\le i\le n$ represent each of the $n$ draws. Define $Y$ as
    ...
    \begin{align}
        p = \frac{1}{2},\ n = 20
    \end{align}
    \item We require $p_Y(\ge 12)$. Since $n = 20$,
             \begin{align}
                p_Y(\ge 12) &= 1 - p_Y(< 12) \\
